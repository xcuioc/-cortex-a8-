...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? 10? 21 18:51:10 2019
# Project:  ATSystem.pro
# Template: app
# Command: f:\qt\Qt-4.7.0\bin\qmake.exe -spec ..\..\qt\Qt-4.7.0\mkspecs\win32-g++ -o Makefile ATSystem.pro
#############################################################################
...
MAKEFILE      = Makefile
QMAKE         = f:\qt\Qt-4.7.0\bin\qmake.exe
DEL_FILE      = del
